...
'بعد جبدي قول 😎',
'مشغول حالياً ??🌸',
'اسـمـي '..Namebot..' هـلا عـــيـــون البـوت   انــYOUــت '
}
...
if text == "هلو" or text == "هلاو"  then  local YAF= {
...
send(msg.chat_id_, msg.id_,'['..YAF[math.random(#YAF)]..']') 
return false
end
