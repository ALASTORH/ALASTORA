...
if text == ("تاك للنعاج") and Mod(msg) then
...
local Fun = {'هذا الله يعينه على نفسه 😒','والله والنعم فيـه💋🙄','يلعب ع البنات 🙄', 'كفووووووووو 😶🙊','حلو يخبل ومعضل','مــدري🤷🏼‍♀️','اموت عليه 🌝','هذا حبيبي قلبي 🤓❤️','نشبه وماعنده سالفه😂صراحه ☹️','كـفـوووو','هذا واحد نشبه 🙄😒','ماطيقه كل ما اكمشه ريحته كنها بخاخ بف باف حشرات 😂🤷‍♀️','نشبه وماعنده سالفه😂🤓'} 
